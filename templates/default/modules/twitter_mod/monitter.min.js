...
function fetch_tweets(elem)
{
    ...
    {
        elem.prepend('<div class="tweet"><div align="center" style="background-image: url(templates/default/modules/twitter_mod/ajax-loader.gif);width:32px; height:32px;margin-left:70px;"></div></div>');
...

    {
...

            {
...

                    {
                        ...
                        var divstr='<div id="tw'+this.id+'" class="tweet"><img width="24" height="24" src="'+this.profile_image_url+'" ><p class="text">'+this.text.linkify().linkuser().linktag()+'<br />&nbsp;<b><a href="http://twitter.com/'+this.from_user+'" target="_blank">'+this.from_user+'</a></b> &nbsp;-&nbsp;<b>'+thedatestr+'</b></p></div>';
