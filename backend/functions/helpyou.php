...
function loadhelppost( ) {
    ...
    while( $post = mysql_fetch_array( $req, MYSQL_ASSOC ) ) {
        ...
        echo '<a onclick="deleteHelpPost(' . $post['id'] . ', \'' . $post['tittle'] . '\');" title="Borrar post" style="font-size: 10px; cursor: pointer; float: right; margin-right: 5px;"><img src="' . base_url . 'backend/imgs/cross.png" /></a>';
